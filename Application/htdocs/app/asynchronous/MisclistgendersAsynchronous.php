...
class MisclistgendersAsynchronous extends ILARIA_ApplicationAsynchronous
{
    ...
    protected function getDisplayStructure()
    {
        ...
        . "<tr class=\"insertor\"><td colspan=\"2\"><a class=\"btn btn-danger btn-sm\" href=\"" . ILARIA_ConfigurationGlobal::buildRequestChain("gender", "insert", array()) . "\" role=\"button\"><span class=\"glyphicon glyphicon-plus\" aria-hidden=\"true\"></span> insert</a></td></tr>"
