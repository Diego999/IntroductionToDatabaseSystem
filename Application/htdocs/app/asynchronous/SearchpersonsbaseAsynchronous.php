...
class SearchpersonsbaseAsynchronous extends ILARIA_ApplicationAsynchronous
{
    protected function getUniqueIdentifier()
    {
        return "searchpersonsbase";
    }
    ...
    protected function getDisplayRow()
    {
        return "<tr class=\\\"" . $this->getElementClass() . "\\\">"
            . "<td><a class=\\\"btn btn-primary btn-xs\\\" href=\\\"" . ILARIA_ConfigurationGlobal::buildRequestChain("person", "details", array('id' => ':id')) . "\\\" role=\\\"button\\\"><span class=\\\"glyphicon glyphicon-arrow-right\\\" aria-hidden=\\\"true\\\"></span></a> :firstname :lastname</td>"
            . "<td>:birthdate</td>"
            . "<td>:deathdate</td>"
            . "</tr>";
    }
    ...
    {
        return "<div>"
        . "<h3 class=\"panel-title\">Persons</h3></div>"
    ...
    protected function getRawContent($params)
    {
        ...
        $content = $model->getPersonsLikeName($params['name']);
        if (!is_array($content))
        {
