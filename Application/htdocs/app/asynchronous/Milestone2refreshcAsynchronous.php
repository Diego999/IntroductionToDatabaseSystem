...
class Milestone2refreshcAsynchronous extends ILARIA_ApplicationAsynchronous
{
    protected function getUniqueIdentifier()
    {
        return "milestone2refreshc";
    }

    protected function getWebPath($params)
    {
        return ILARIA_ConfigurationGlobal::buildRequestChain("milestone2", "refreshc", $params);
    }
    ...
    {
        return "<div>"
        . "<h3 class=\"panel-title\">Career duration - refreshing materialized view</h3></div>"
