...
class ProductionalternativetitlesAsynchronous extends ILARIA_ApplicationAsynchronous
{
    protected function getUniqueIdentifier()
    {
        return "productionalternativetitle";
    }
    ...
    {
        return "<div>"
        . "<h3 class=\"panel-title\">Alternative titles</h3></div>"
    ...
    protected function getRawContent($params)
    {
        ...
        $content = $model->getProductionAlternativeTitles($params['prod_id'], $params['maintitle_id']);
        if (!is_array($content))
        {
            throw new ILARIA_CoreError("An error occurred while searching through the alternative titles",
