...
class Milestone2queryeAsynchronous extends ILARIA_ApplicationAsynchronous
{
    protected function getUniqueIdentifier()
    {
        return "milestone2querye";
    }

    protected function getWebPath($params)
    {
        return ILARIA_ConfigurationGlobal::buildRequestChain("milestone2", "querye", $params);
    }
    ...
    {
        return "<div>"
        . "<h3 class=\"panel-title\">Height of female persons</h3></div>"
