...
class Milestone3queryaAsynchronous extends ILARIA_ApplicationAsynchronous
{
    protected function getUniqueIdentifier()
    {
        return "milestone3querya";
    }

    protected function getWebPath($params)
    {
        return ILARIA_ConfigurationGlobal::buildRequestChain("milestone3", "querya", $params);
    }
    ...
    {
        return "<div>"
        . "<h3 class=\"panel-title\">Actors 55 year older than youngest ones in production</h3></div>"
