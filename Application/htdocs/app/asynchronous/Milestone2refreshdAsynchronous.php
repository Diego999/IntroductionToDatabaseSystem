...
class Milestone2refreshdAsynchronous extends ILARIA_ApplicationAsynchronous
{
    protected function getUniqueIdentifier()
    {
        return "milestone2refreshd";
    }

    protected function getWebPath($params)
    {
        return ILARIA_ConfigurationGlobal::buildRequestChain("milestone2", "refreshd", $params);
    }
    ...
    {
        return "<div>"
        . "<h3 class=\"panel-title\">Number of actors per production - refreshing materialized view</h3></div>"
