...
class Milestone2querygAsynchronous extends ILARIA_ApplicationAsynchronous
{
    protected function getUniqueIdentifier()
    {
        return "milestone2queryg";
    }

    protected function getWebPath($params)
    {
        return ILARIA_ConfigurationGlobal::buildRequestChain("milestone2", "queryg", $params);
    }
    ...
    {
        return "<div>"
        . "<h3 class=\"panel-title\">Most popular characters</h3></div>"
