...
class Milestone3refreshkAsynchronous extends ILARIA_ApplicationAsynchronous
{
    protected function getUniqueIdentifier()
    {
        return "milestone3refreshk";
    }

    protected function getWebPath($params)
    {
        return ILARIA_ConfigurationGlobal::buildRequestChain("milestone3", "refreshk", $params);
    }
    ...
    {
        return "<div>"
        . "<h3 class=\"panel-title\">Companies that released most movies - refreshing materialized view</h3></div>"
