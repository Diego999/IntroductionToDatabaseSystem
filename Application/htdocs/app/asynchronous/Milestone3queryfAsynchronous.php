...
class Milestone3queryfAsynchronous extends ILARIA_ApplicationAsynchronous
{
    protected function getUniqueIdentifier()
    {
        return "milestone3queryf";
    }

    protected function getWebPath($params)
    {
        return ILARIA_ConfigurationGlobal::buildRequestChain("milestone3", "queryf", $params);
    }
    ...
    {
        return "<div>"
        . "<h3 class=\"panel-title\">Average number of episodes per season</h3></div>"
