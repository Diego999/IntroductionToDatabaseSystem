...
class Milestone2querydAsynchronous extends ILARIA_ApplicationAsynchronous
{
    protected function getUniqueIdentifier()
    {
        return "milestone2queryd";
    }

    protected function getWebPath($params)
    {
        return ILARIA_ConfigurationGlobal::buildRequestChain("milestone2", "queryd", $params);
    }
    ...
    {
        return "<div>"
        . "<h3 class=\"panel-title\">Number of actors per production</h3></div>"
