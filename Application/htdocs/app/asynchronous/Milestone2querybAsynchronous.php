...
class Milestone2querybAsynchronous extends ILARIA_ApplicationAsynchronous
{
    protected function getUniqueIdentifier()
    {
        return "milestone2queryb";
    }

    protected function getWebPath($params)
    {
        return ILARIA_ConfigurationGlobal::buildRequestChain("milestone2", "queryb", $params);
    }
    ...
    {
        return "<div>"
        . "<h3 class=\"panel-title\">10 countries with most production companies</h3></div>"
