...
class SearchgendersbaseAsynchronous extends ILARIA_ApplicationAsynchronous
{
    protected function getUniqueIdentifier()
    {
        return "searchgendersbase";
    }

    protected function getWebPath($params)
    {
        return ILARIA_ConfigurationGlobal::buildRequestChain("search", "gendersbase", $params);
    }
    ...
    protected function getDisplayRow()
    {
        return "<tr class=\\\"" . $this->getElementClass() . "\\\">"
            . "<td>:name</td>"
            . "<td><a class=\\\"btn btn-default\\\" href=\\\"#\\\" role=\\\"button\\\" " . ILARIA_ApplicationAsynchronous::getModalOnClickShow(ILARIA_ConfigurationGlobal::buildRequestChain('search', 'gendermovies', array('id' => ':id')), true) . "><span class=\\\"glyphicon glyphicon-align-justify\\\" aria-hidden=\\\"true\\\"></span> :count_prod</a></td>"
            . "</tr>";
    }
    ...
    {
        return "<div>"
        . "<h3 class=\"panel-title\">Genres</h3></div>"
    ...
    protected function getRawContent($params)
    {
        ...
        $content = $model->getGendersLikeName($params['name']);
        if (!is_array($content))
        {
